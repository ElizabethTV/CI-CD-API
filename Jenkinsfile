pipeline {
    ...
    stages {
        ...
        stage ('Docker Push') {
            steps {
                withCredentials([usernamePassword(credentialsId: '0abc1b4f-2c19-4f22-be49-f27b8903d2a9', passwordVariable: 'DOCKERHUB_PASSWORD', usernameVariable: 'DOCKERHUB_USERNAME')]){
